...
<div class="loginWrapper">
	...
	<div class="widget">
        ...
        <form style="clear:left;" action="<?php echo site_url('administration/auth/remind'); ?>" id="validate" class="form" method="post">
            <fieldset>
                <div class="formRow" style="padding-top: 15%;">
                ...
                <div class="loginControl">
                    <div class="rememberMe" style="display: none;"><input type="checkbox" id="remMe" name="remember" /><label for="remMe">Remember me</label></div>
                    <input type="submit" value="Send Password" class="dredB logMeIn" />
                    <div class="clear"></div>
                </div>
            </fieldset>
        </form>
