...
$_SERVER['PATH_INFO'] = '/external/recover_get_array/'.$query_string;
 ...
 *
 */
	$system_path = realpath(dirname(__FILE__) . "/../../iu-system");
...
require_once APPPATH.'external/CodeIgniter'.EXT;
